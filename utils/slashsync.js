...
module.exports = async (client, commands, options = {
    ...
    log(`Actuellement, les commandes ${currentCommands.size} sont enregistrées dans le bot.`);
    ...
    log(`Création de commandes ${newCommands.length} !`);
    ...
    log(`Commandes ${deletedCommands.length} supprimées !`);
    ...
    log(`Commandes ${updatedCommandCount} mises à jour !`);
